...
<body>
    <header>
        <div class="header-items">
            ...
            <nav>
                <ul>
                    <li><a class="active" href="#">Список сотрудников</a></li>
        ...
        <form action="" method="POST">
            ...
            <div class="main-content">
                <div class="top-table">
                    <div class="newdates">
                        ...
                        <div class="newdates-item">
                            <input name="region" value="<?php print($new['region']); ?>" placeholder="регион">
                        </div>
                        <div class="newdates-item">
                    ...
                    <div id="filter-block" style="display:none;">
                        ...
                        <div class="row">
                            <div class="multiselect">
                                ...
                                <div id="checkboxes1">
                                    <?php
                                    $stmt = $db->prepare("SELECT age FROM Sotrudniki ORDER BY age");
                                    $stmt->execute();
                            ...
                            <div class="multiselect">
                                ...
                                <div id="checkboxes2">
                                    <?php
                                    $stmt = $db->prepare("SELECT id, region FROM Sotrudniki ORDER BY region");
                                    $stmt->execute();
                                    $Regions = $stmt->fetchAll(PDO::FETCH_ASSOC);
                                    foreach ($Regions as $region) {
                                        echo '<label for="region'.$region['region'].'"><input type="checkbox" ';
                                        echo empty($filter_region_ids) ? "" : (in_array($region['region'], $filter_region_ids) ? "checked " : "");
                                        echo 'name="filter_region_'.$region['region'].'" id="region'.$region['region'].'">'.$region['region'].'</label>';
                                    }
                                    ?>
            ...
            <?php
                ...
                foreach ($values as $value) {
                    ...
                    echo        '<td>
                                    <input'; if(empty($_COOKIE['edit']) || ($_COOKIE['edit'] != $value['id'])) print(" disabled ");
                                    else print(" "); echo 'name="region'.$value['id'].'" value="'.$value['region'].'">
                                </td>';
