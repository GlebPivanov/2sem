        ...
        <div class="header-items">
            ...
            <nav>
                <ul>
                    ...
                    <li><a class="active" href="#">Список затрат</a></li>
    ...
    <main>
        ...
        <form action="" method="POST">
            <div class="main-content">
                <h2>Список видов затрат</h2>
            </div>
            <div class="main-content">
                <div class="newdates">
                    <div class="newdates-item">
                        <label for="name">Вид затрат:</label>
                    </div>
                    <div class="newdates-item">
                        <input name="name" value="<?php print($new['name']); ?>" placeholder="вид затрат">
                    </div>
                    <div class="newdates-item">
