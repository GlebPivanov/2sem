...
$user = 'u52845';
$pass = '1206720';
$db = new PDO('mysql:host=localhost;dbname=u52845', $user, $pass, array(PDO::ATTR_PERSISTENT => true));
...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
  ...
  $values['hand'] = empty($_COOKIE['hand_value']) ? '' : htmlspecialchars(strip_tags(strip_tags($_COOKIE['hand_value'])));
